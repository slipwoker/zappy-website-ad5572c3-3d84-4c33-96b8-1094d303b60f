document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (submitBtn) {
        ...
        // Re-enable after timeout as fallback (for non-AJAX forms)
        setTimeout(function () {
  ...
  const animatedElements = document.querySelectorAll(
    '.fade-in, .animate-on-scroll, [data-animate], .section-title, .feature-card, .service-card, .pricing-card, .testimonial-card, .team-card, .blog-card, .hero-content, .about-content, .cta-content'
  );
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Fernando Pastry Chef משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ad5572c3-3d84-4c33-96b8-1094d303b60f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ad5572c3-3d84-4c33-96b8-1094d303b60f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ad5572c3-3d84-4c33-96b8-1094d303b60f';
